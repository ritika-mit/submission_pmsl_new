...
class HandleInertiaRequests extends Middleware
{
    ...
    public function aside(Request $request)
    {
        ...
        $items = array_map(function ($item) use ($user, $request) {
            ...
            $badge = isset($route[0], $route[1], $route[1]['filter']) && $route[0] === 'manuscripts.index' || $route[0] === 'formatter.index' || $route[0] === 'proofreader.index' && $route[1]['filter'] instanceof Filter
