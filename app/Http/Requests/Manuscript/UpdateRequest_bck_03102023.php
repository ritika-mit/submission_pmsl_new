    ...
    public function rules(): array
    {
        ...
        return match ($this->route('action')) {
            Action::CREATE, Action::EDIT => [
                ...
                'anonymous_file' => [$revision?->anonymous_file ? 'nullable' : 'required', 'file', 'mimes:pdf', 'max:8000'],
                'source_file' => [$revision?->source_file ? 'nullable' : 'required', 'file', 'mimes:doc,docx', 'max:8000'],
                'copyright_form' => [$manuscript?->copyright_form ? 'nullable' : 'required', 'file', 'mimes:jpg,jpeg,png,gif,pdf', 'max:8000'],
            ],
            ...
            Action::REVIEW => [
                ...
                'review_report' => ['nullable', 'file', 'mimes:doc,docx,jpg,jpeg,png,gif,pdf', 'max:8000'],
            ],
            ...
            Action::REVISE => [
                ...
                'comment_reply_file' => ['required', 'file', 'mimes:pdf', 'max:8000'],
                'anonymous_file' => ['required', 'file', 'mimes:pdf', 'max:8000'],
                'source_file' => ['required', 'file', 'mimes:doc,docx', 'max:8000'],
            ],
