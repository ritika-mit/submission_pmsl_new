...
class RevisionReminder extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('IJMEMS-Kindly submit your revised paper with replies of reviewers & editor\'s comments')
            ...
            ->line("Kindly login to your account at https://submission.ijmems.in.  After login, follow the below steps to complete the revision process:")
