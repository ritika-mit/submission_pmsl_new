...
class RevisionRequired extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line("We have received the review reports from our advisors on your manuscript. Based on the advice received, we feel that your manuscript could be reconsidered for publication should you be prepared to incorporate reviewer comments/editor's comments. When preparing your revised manuscript, you are asked to carefully consider the reviewer comments/editor's comments, ***which can be found- at the side link \"Under Revision\" under \"ACTION\" from the drop-down, click on \"View\" and see the all reviewer’s comments. *** and submit a list of responses (write a reply to each comment) to the comments with your revised manuscript. Editor's Common Comments can be downloaded from this [link](https://www.ijmems.in/assets/editor-common-comments.pdf)")
            ...
            ->line("Before the revised manuscript submission, kindly go through the journal Guidelines for Authors at [https://journals.ramartipublishers.com/PMSL/forauthors.php](https://journals.ramartipublishers.com/PMSL/forauthors.php) and the latest published issue, very very carefully.")
            ->line("Kindly submit your all materials (all comment replies; anonymous revised manuscript pdf file; revised manuscript in .docx file with author names, conflict of interest and acknowledgement statements) within ***30 days*** after receiving this email, through your login user id at PMSL submission system link [https://submissionpmsl.ramartipublishers.com](https://submissionpmsl.ramartipublishers.com)")
