...
class ConditionallyAccepted extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Your manuscript is conditionally accepted - Prabha Materials Science Letters')
            ->greeting(implode(' ', array_filter([$notifiable->title, $notifiable->name, ', WITH CC TO ALL AUTHORS'])))
            ->line('We are pleased to inform you that your manuscript has been ***conditionally accepted*** for publication in the Prabha Materials Science Letters. Final acceptance will be done after receiving the Article Processing Charges (APCs).')
