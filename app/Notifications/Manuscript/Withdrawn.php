...
class Withdrawn extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Your manuscript is withdrawn - Prabha Materials Science Letters')
            ->greeting(implode(' ', array_filter([$notifiable->title, $notifiable->name, ', WITH CC TO ALL AUTHORS'])))
            ->line('Thank you for considering PMSL as a venue for your manuscript.')
            ->line('Publishing in PMSL is becoming increasingly competitive, as there is limited space in the journal.')
            ...
            ->line('PMSL receives many submissions and we have to prioritize to publish multidisciplinary mathematical, engineering & management research [(https://journals.ramartipublishers.com/PMSL/aimandscope.php)](https://journals.ramartipublishers.com/PMSL/aimandscope.php) addressing clearly defined scientific questions of broad readership interest and impact.')
            ->line('This decision has nothing to do with the novelty or quality of the described work.')
            ->line('As such, we formally release you to submit your work to a more appropriate journal on time. We know you will be disappointed by this response but we should nevertheless like to thank you for considering PMSL as a location for your work.')
