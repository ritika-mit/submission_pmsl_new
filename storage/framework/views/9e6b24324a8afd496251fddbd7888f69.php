...
Dear ***<?php echo e($greeting ?? 'Author'); ?>***,
...
<?php echo app('translator')->get('Thank you for your cooperation and with regards.'); ?><br>
<?php echo app('translator')->get('Editor'); ?><br>
<?php echo e(config('app.full_name')); ?><br>
...
<?php echo app('translator')->get("If you're having trouble clicking the \":actionText\" button, copy and paste the URL below\n" . 'into your web browser:', compact('actionText')); ?> <span class="break-all">[<?php echo e($displayableActionUrl); ?>](<?php echo e($actionUrl); ?>)</span>
 <?php $__env->endSlot(); ?>
<?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\hmitt\Downloads\submission_ijmems_for_pmsl\submission_ijmems_for_pmsl\resources\views/notifications/email.blade.php ENDPATH**/ ?>