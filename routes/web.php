...
Route::middleware('auth', 'verified:auth.notice')->group(function () {
    ...
    Route::prefix('authors')->name('authors.')->controller(AuthorController::class)->group(function () {
        ...
        Route::get('{author}/confirm-delete', 'confirmDelete')->name('confirm-delete');
        Route::delete('{author}/destroy', 'destroy')->name('destroy');

        // Route::get(uri: '{author}/confirm-delete', action: 'confirmDestroy')->name('confirmDestroy');
        // Route::delete(uri: '{author}/destroy', action: 'destroy')->name('destroy');
        //Route::delete(uri: '{author}/destroy', action: 'destroy');
