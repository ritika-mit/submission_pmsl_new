...
<template>
    <Layout title="Profile">
        ...
        <form @submit.prevent="form.post(url.current)" id="edit-form" class="border md:p-8 rounded shadow bg-white w-full grid grid-cols-1 md:grid-cols-2 gap-2 p-4 md:gap-4 mb-6" novalidate>
            <div>
